...
createApp({
  setup() {
    ...
    const allProducts = [
      ...
      { id:40, catId:'homeware',     subId:'dorm-access',    subName:'Dorm Accessories',            emoji:'🧸',   name:'Hangers',                     image:'images/hangers.jpg',                    desc:'Clothing rack, 3 tiers.',                                          price:449.99,  stock:'in'  },
